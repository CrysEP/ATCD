    ...
    <table class="header-table">
        <tr>
            ...
            <td style="width: 20%; text-align: right;">
                @if(file_exists(public_path('images/logo_gobernacion.png')))
                    <img src="{{ public_path('images/logo_gobernacion.png') }}" class="logo">
                @endif
            </td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col-desc">
                    {{-- Recortamos a 25 palabras para mantener el formato vertical limpio --}}
